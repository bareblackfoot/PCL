...
parser.add_argument('--sample-duration', default=16, type=int,
                    help='sample duration (default: 16)')
parser.add_argument(
    "--noisydepth",
    action='store_true',
    default=False,
...
def train(train_loader, model, criterion, optimizer, epoch, args, cluster_result=None):
    ...
    for i, (images, masks, index, scene_idx) in enumerate(train_loader):
        ...
        # Scene loss
        loss_scene = -0.001 * criterion(feat, scene_idx)
